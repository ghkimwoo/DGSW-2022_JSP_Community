...
<%@ page import="java.util.List" %><%
    ...
    String access = (String) session.getAttribute("username");
...
<div class="container  mt-3">
    <h3 class="bg-black p-2 text-white bg-opacity-75">멤버게시판  |  <small class="text-muted">가입한 회원만이 접근할 수 있습니다.</small> </h3>
    <div class="row">
        <div class="col">
